        ...
        <div className="p-12">
            <div className="">
                <div className="block md:flex justify-between gap-4">
                    <div className="flex gap-2  md:justify-between md:gap-4 pl-7">
                        <p className="text-4xl font-semibold">Mobile App</p>
                        <svg className="mt-2" width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M53.25 27.5H60.75C67 27.5 69.5 25 69.5 18.75V11.25C69.5 5 67 2.5 60.75 2.5H53.25C47 2.5 44.5 5 44.5 11.25V18.75C44.5 25 47 27.5 53.25 27.5Z" fill="#5030E5" fill-opacity="0.2" />
                            <path d="M58.9933 19.3167H60C62.3828 19.3167 64.3167 17.3829 64.3167 15C64.3167 12.6172 62.3828 10.6833 60 10.6833H59C58.6359 10.6833 58.35 10.9785 58.35 11.3333C58.35 11.6895 58.6438 11.9833 59 11.9833H60C61.6638 11.9833 63.0167 13.3362 63.0167 15C63.0167 16.6638 61.6638 18.0167 60 18.0167H58.9933C58.6372 18.0167 58.3433 18.3105 58.3433 18.6667C58.3433 19.0229 58.6372 19.3167 58.9933 19.3167Z" fill="#5030E5" stroke="#5030E5" stroke-width="0.3" />
                            <path d="M54 19.3167H55C55.3562 19.3167 55.65 19.0229 55.65 18.6667C55.65 18.3105 55.3562 18.0167 55 18.0167H54C52.3362 18.0167 50.9833 16.6638 50.9833 15C50.9833 13.3362 52.3362 11.9833 54 11.9833H55C55.3562 11.9833 55.65 11.6895 55.65 11.3333C55.65 10.9772 55.3562 10.6833 55 10.6833H54C51.6172 10.6833 49.6833 12.6172 49.6833 15C49.6833 17.3829 51.6172 19.3167 54 19.3167Z" fill="#5030E5" stroke="#5030E5" stroke-width="0.3" />
                            <path d="M54.3333 15.65H59.6667C60.0228 15.65 60.3167 15.3562 60.3167 15C60.3167 14.6438 60.0228 14.35 59.6667 14.35H54.3333C53.9772 14.35 53.6833 14.6438 53.6833 15C53.6833 15.3562 53.9772 15.65 54.3333 15.65Z" fill="#5030E5" stroke="#5030E5" stroke-width="0.3" />
                        </svg>
                    ...
                    <div className="flex ml-8 md:justify-between gap-2 md:pr-24 mt-4">
                        ...
                        <p className="mt-1 text-indigo-600 font-medium">Invite</p>
                ...
                <div className="block md:flex justify-between  mt-4 gap-2 pl-7">
                    ...
                    <div className="flex  mt-4 gap-3 pr-24">
                        ...
                        <svg className="mt-2" width="2" height="29" viewBox="0 0 2 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg width="83" height="40" viewBox="0 0 83 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M77.1949 17.9999C78.5756 17.9999 79.6949 16.8807 79.6949 15.4999C79.6949 14.1192 78.5756 12.9999 77.1949 12.9999C75.8142 12.9999 74.6949 14.1192 74.6949 15.4999C74.6949 16.8807 75.8142 17.9999 77.1949 17.9999Z" stroke="#787486" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M67.5 17.9999C68.8807 17.9999 70 16.8807 70 15.4999C70 14.1192 68.8807 12.9999 67.5 12.9999C66.1193 12.9999 65 14.1192 65 15.4999C65 16.8807 66.1193 17.9999 67.5 17.9999Z" stroke="#787486" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M77.1949 27.9999C78.5756 27.9999 79.6949 26.8807 79.6949 25.4999C79.6949 24.1192 78.5756 22.9999 77.1949 22.9999C75.8142 22.9999 74.6949 24.1192 74.6949 25.4999C74.6949 26.8807 75.8142 27.9999 77.1949 27.9999Z" stroke="#787486" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M67.5 27.9999C68.8807 27.9999 70 26.8807 70 25.4999C70 24.1192 68.8807 22.9999 67.5 22.9999C66.1193 22.9999 65 24.1192 65 25.4999C65 26.8807 66.1193 27.9999 67.5 27.9999Z" stroke="#787486" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                </div>
